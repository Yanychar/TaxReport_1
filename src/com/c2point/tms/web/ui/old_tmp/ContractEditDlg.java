...
public class ContractEditDlg extends Window {
	...
	public ContractEditDlg( Contract contract, SitesModel model, ModType modType ) {
	...
	public ContractEditDlg( SitesModel model, ModType modType ) {
